...
\begin{refsection}[refs/alternative]
\input{source/alternative}
\nocite{*}
\printbibliography[title={References}, heading=subbibliography]
\end{refsection}

\begin{refsection}[refs/GPT]
\input{source/GPT}
\nocite{*}
\printbibliography[title={References}, heading=subbibliography]
\end{refsection}

\begin{refsection}[refs/zhejiang]
\input{source/zhejiang}
\nocite{*}
\printbibliography[title={References}, heading=subbibliography]
\end{refsection}

\begin{refsection}[refs/whyonechild]
\input{source/whyonechild}
\nocite{*}
\begin{CJK}{UTF8}{gbsn}
\printbibliography[title={References}, heading=subbibliography]
\end{CJK}
...
\begin{refsection}[refs/expert]
\input{source/expert}
\nocite{*}
\printbibliography[title={References}, heading=subbibliography]
\end{refsection}

\begin{refsection}[refs/incompat]
\input{source/incompat}
\nocite{*}
\printbibliography[title={References}, heading=subbibliography]
\end{refsection}
